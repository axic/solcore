...
spec =
  testGroup
    ...
    [ runTestForFile "00answer.solc" specFolder,
      ...
      runTestForFile "012nid.solc" specFolder,
      runTestForFile "013comp.solc" specFolder,
      ...
      runTestForFile "027sstore.solc" specFolder,
      ...
      runTestForFile "051expreturn.solc" specFolder,
      runTestForFile "051negBool.solc" specFolder,
      runTestForFile "052negPair.solc" specFolder,
      runTestForFile "052return.solc" specFolder,
      runTestForFile "053return.solc" specFolder,
      runTestForFile "06comp.solc" specFolder,
      runTestForFile "09not.solc" specFolder,
      runTestForFile "101struct1Field.solc" specFolder,
      runTestForFile "102uintField.solc" specFolder,
      runTestForFile "103struct3Fields.solc" specFolder,
      runTestForFile "105nestedStruct.solc" specFolder,
      runTestForFile "10negBool.solc" specFolder,
      runTestForFile "111storageStruct.solc" specFolder,
      runTestForFile "112ContractStorage.solc" specFolder,
      runTestForFile "113counter.solc" specFolder,
      runTestForFile "11negPair.solc" specFolder,
      runTestForFile "120basicCounter.solc" specFolder,
      runTestForFile "122counters.solc" specFolder,
      runTestForFile "123stackAndStorage.solc" specFolder,
      runTestForFile "131constructor.solc" specFolder,
      runTestForFile "135cons3.solc" specFolder,
      ...
      runTestForFile "StorageLib.solc" specFolder,
...
dispatches =
  testGroup
    ...
    [ runDispatchTest "basic.solc",
      ...
      runDispatchTest "counter.solc",
      runDispatchTest "fib.solc",
      runDispatchTest "neg.solc",
      runDispatchTest "ownable.solc"
    ]
  where
...
cases =
  testGroup
    ...
    [ runTestForFile "Ackermann.solc" caseFolder,
      ...
      runTestForFile "dispatch.solc" caseFolder,
      ...
      runTestForFile "ltproxy.solc" caseFolder,
      ...
      runTestForFile "simpleIfExpr.solc" caseFolder,
      runTestForFile "simpleIfStmt.solc" caseFolder,
